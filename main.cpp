...
//My own MAIN Implementation
   
   Chain i(png1,1,16);
   i.insertFront(b);
   PNG result8 = i.render(1,16);
   result8.writeToFile("images/out-insertfront.png");

   Chain z(png1,1,16);
   z.insertBack(b);
   PNG result9 = z.render(1,16);
   result9.writeToFile("images/out-insertback.png");


   Chain n(png1,1,16);
   n.rotate(3);
   PNG result10 = n.render(1,16);
   result10.writeToFile("images/out-rotate.png");

   png1.readFromFile("images/rosegarden.png");
   PNG result11 = ubcify(png1);
   result11.writeToFile("images/out-ubcify-rosegarden.png");
